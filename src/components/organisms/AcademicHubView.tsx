...
export const AcademicHubView: React.FC<AcademicHubViewProps> = ({
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      {/* Top Academic Greeting & Status Card */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 sm:p-5 rounded-2xl bg-white dark:bg-[#1E1F20] border border-black/[0.08] dark:border-white/[0.08] shadow-sm transition-colors">
        <div>
          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
            <Badge variant="blue" size="sm">
              <GeminiIcon name="sparkle" size={12} className="text-[#0B57D0] dark:text-[#A8C7FA]" />
          ...
          <h1 className="text-xl sm:text-2xl font-semibold tracking-tight text-neutral-900 dark:text-white font-sans">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-[#0B57D0] dark:bg-[#A8C7FA] text-white dark:text-neutral-950 text-xs font-medium hover:opacity-90 transition-all active:scale-95"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-black/[0.04] dark:bg-white/[0.06] border border-black/[0.08] dark:border-white/[0.08] text-neutral-800 dark:text-neutral-200 text-xs font-medium hover:bg-black/[0.08] dark:hover:bg-white/[0.1] transition-all active:scale-95"
          >
          ...
          <GeminiCard className="h-full flex flex-col justify-between" glow>
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h2 className="text-sm font-semibold text-neutral-900 dark:text-white">Today's Class Schedule</h2>
                    <p className="text-[10px] font-mono text-neutral-500 dark:text-neutral-400">Monday Routine</p>
                  </div>
                </div>
              ...
              {/* Active Lecture Box */}
              <div className="p-3.5 rounded-xl bg-neutral-50 dark:bg-[#282A2C] border border-[#0B57D0]/20 dark:border-[#A8C7FA]/20 mb-3">
                <div className="flex justify-between items-start">
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-bold text-neutral-900 dark:text-white tracking-tight">ECO 201</span>
                      <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-[#0B57D0]/10 dark:bg-[#A8C7FA]/15 text-[#0B57D0] dark:text-[#A8C7FA] font-medium">In Progress</span>
                    </div>
                    <p className="text-xs text-neutral-700 dark:text-neutral-200 mt-1">Principles of Microeconomics II</p>
                    <p className="text-[11px] font-mono text-neutral-500 dark:text-neutral-400 mt-0.5">Lecturer: Dr. K. Balogun</p>
                  </div>
                  <div className="text-right">
                    <span className="text-xs font-mono text-[#0B57D0] dark:text-[#A8C7FA] font-semibold">08:00 - 10:00</span>
                    <p className="text-[11px] text-neutral-500 dark:text-neutral-400 mt-1">SMS LT1</p>
                  </div>
                </div>

                <div className="mt-3 pt-2.5 border-t border-black/[0.06] dark:border-white/[0.06] flex items-center justify-between text-xs">
                  <span className="text-[11px] text-neutral-500 dark:text-neutral-400">Tiered Seating Section B</span>
                  <button
                    onClick={() => onSelectVenue('SMS-LT1')}
              ...
              {/* Next Lecture */}
              <div className="p-3 rounded-xl bg-black/[0.02] dark:bg-white/[0.03] border border-black/[0.06] dark:border-white/[0.06] flex justify-between items-center text-xs">
                <div>
            ...
            <div className="mt-4 pt-3 border-t border-black/[0.06] dark:border-white/[0.06] flex items-center justify-between text-[11px] font-mono text-neutral-500 dark:text-neutral-400">
              <div className="flex items-center gap-1.5">
                <GeminiIcon name="shield-check" size={14} className="text-[#0B57D0] dark:text-[#A8C7FA]" />
                <span>Verified by Economics Reps</span>
              </div>
        ...
        <GeminiCard>
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-sm font-semibold text-neutral-900 dark:text-white">Campus Transit Hub</h3>
                <p className="text-[10px] font-mono text-neutral-500 dark:text-neutral-400">Permanent Site Shuttle</p>
              </div>
            </div>
        ...
        <GeminiCard>
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-sm font-semibold text-neutral-900 dark:text-white">Department Secretariat</h3>
                <p className="text-[10px] font-mono text-neutral-500 dark:text-neutral-400">Wing B, 1st Floor SMS</p>
              </div>
            </div>
